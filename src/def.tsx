export const def = {
  allHeroes: [
    ...
    },
    {
      ...
      position: 50,
      code: "02050",
      name: "Prince Imrahil (Leadership)",
      traits: "Gondor. Noble.",
    ...
    },
    {
      ...
      position: 1,
      code: "18001",
      name: "Brand son of Bain (Leadership)",
      traits: "Dale. Noble.",
    ...
    },
    {
      ...
      position: 72,
      code: "02072",
      name: "Brand son of Bain (Tactics)",
      traits: "Dale.",
    ...
    },
    {
      ...
      position: 81,
      code: "22081",
      name: "Gildor Inglorion (Leadership)",
      traits: "Noldor. Noble.",
    ...
    },
    {
      ...
      sphere_name: "Lore",
      position: 53,
      code: "Fingolfin (First Age) (non-FFG custom hero)",
      name: "Fingolfin (First Age) (non-FFG custom hero)",
      traits: "Dúnedain. Ranger.",
      text: "Sentinel.\n<b>Refresh Action:</b> Reduce your threat to your starting threat level. (Limit once per game.)",
      flavor: "",
      is_unique: true,
    ...
    },
    {
      ...
      sphere_name: "Lore",
      position: 53,
      code: "Faenor (First Age) (non-FFG custom hero)",
      name: "Faenor (First Age) (non-FFG custom hero)",
      traits: "Dúnedain. Ranger.",
      text: "Sentinel.\n<b>Refresh Action:</b> Reduce your threat to your starting threat level. (Limit once per game.)",
      flavor: "",
      is_unique: true,
    ...
    },
    {
      ...
      sphere_name: "Lore",
      position: 53,
      code: "Earendil (First Age) (non-FFG custom hero)",
      name: "Earendil (First Age) (non-FFG custom hero)",
      traits: "Dúnedain. Ranger.",
      text: "Sentinel.\n<b>Refresh Action:</b> Reduce your threat to your starting threat level. (Limit once per game.)",
      flavor: "",
      is_unique: true,
    ...
    },
    {
      ...
      sphere_name: "Lore",
      position: 53,
      code: "Idril Celebrindal (First Age) (non-FFG custom hero)",
      name: "Idril Celebrindal (First Age) (non-FFG custom hero)",
      traits: "Dúnedain. Ranger.",
      text: "Sentinel.\n<b>Refresh Action:</b> Reduce your threat to your starting threat level. (Limit once per game.)",
      flavor: "",
      is_unique: true,
    ...
    },
    {
      ...
      sphere_name: "Lore",
      position: 53,
      code: "Ecthelion (First Age) (non-FFG custom hero)",
      name: "Ecthelion (First Age) (non-FFG custom hero)",
      traits: "Dúnedain. Ranger.",
      text: "Sentinel.\n<b>Refresh Action:</b> Reduce your threat to your starting threat level. (Limit once per game.)",
      flavor: "",
      is_unique: true,
  ...
  boonsAndBurdens: {
    boons: [
      {
        ...
        index: 1,
        image: "Ruthless",
        extraInfo: "attached to Faenor",
      },
      {
        name: "Cunning",
        index: 2,
        image: "Cunning",
        extraInfo: "attached to Gandalf",
      },
      {
        name: "Hardy",
        index: 3,
    ...
    burdens: [{ name: "Protect the Innocent (0 damage counters)", index: 1 }],
  },
  scenarios: [
    {
      name: "Intruders in Chettwood",
    ...
    {
      name: "Nightmare Intruders in Chettwood",
      campaign: "Angmar Awakened",
      index: 1,
      current: false,
      won: true,
    ...
    {
      name: "Nightmare The Weather Hills",
      campaign: "Angmar Awakened",
      index: 3,
      current: false,
      won: true,
    ...
    {
      name: "Nightmare Wastes of Eriador",
      campaign: "Angmar Awakened",
      index: 7,
      current: false,
      won: false,
    ...
    {
      name: "Nightmare Escape from Mount Gram",
      campaign: "Angmar Awakened",
      index: 9,
      current: false,
      won: false,
    ...
    {
      name: "Nightmare Across the Ettenmoors",
      campaign: "Angmar Awakened",
      index: 11,
      current: false,
      won: false,
    ...
    {
      name: "Nightmare The Treachery of Rhûdaur",
      campaign: "Angmar Awakened",
      index: 13,
      current: false,
      won: false,
    ...
    {
      name: "Nightmare The Battle of Carn Dûm",
      campaign: "Angmar Awakened",
      index: 15,
      current: false,
      won: false,
    ...
    {
      name: "Nightmare The Dread Realm",
      campaign: "Angmar Awakened",
      index: 17,
      current: false,
      won: false,
